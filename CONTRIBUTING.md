Contributing to MERGEX Core
============================

The MERGEX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mergexpay/mergex/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the MERGEX Core project (and related
projects such as libsecp256k1), and is not to be confused with overall MERGEX
Network Protocol consensus changes.

Whether a pull request is merged into MERGEX Core rests with the project merge
...
Patches that change MERGEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the MERGEX consensus, it must have been
...
The review process is normally fairly responsive on the MERGEX Core repository, however
...
The project leader is the release manager for each MERGEX Core release.
