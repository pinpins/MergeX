...
https://github.com/mergexpay/mergex_hash
...
JSON-RPC server. Running `mergexd` or `mergex-qt -server` will be sufficient.
...
* `input`: mergexd blocks/ directory containing blkNNNNN.dat
