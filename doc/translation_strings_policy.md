...
This document provides guidelines for internationalization of the MERGEX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mergex_en.ts` remains unchanged.
