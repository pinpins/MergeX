...
* mergex.conf: contains configuration settings for mergexd or mergex-qt
* mergexd.pid: stores the process id of mergexd while running
...
* debug.log: contains debug information and general logging generated by mergexd or mergex-qt
