...
class BlockRewardReallocationTest(MERGEXTestFramework):
    def set_test_params(self):
        self.set_mergex_test_params(2, 1, fast_dip3_enforcement=True)
        self.set_mergex_dip8_activation(450)
    ...
    def run_test(self):
        ...
        assert_equal(bt['masternode'][0]['amount'], 6874285801) # 0.49999912971
