...
"""Verify that starting mergexd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mergexd with -h for help text")
        ...
        self.log.info("Start mergexd with -version for version information")
